...
```
	php 		12年 项目架构能力 & 框架定制 & 扩展开发
	javascript  14年 vue / react / electron 项目开发能力
	go 			 3年 项目架构能力 & 框架开发能力 
	java 		 4年 基于 spring-boot 的项目架构 & 基于 sprint-cloud 的项目开发
```
